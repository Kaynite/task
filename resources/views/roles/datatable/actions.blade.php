<a href="{{ route('roles.edit', $id) }}"
    class="border border-secondary btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
...
<a href="#" class="border border-secondary btn btn-icon btn-bg-light btn-active-color-danger btn-sm"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">@lang('admin.delete role')</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                @lang('admin.gen delete msg', ['name' => $name])
            </div>
